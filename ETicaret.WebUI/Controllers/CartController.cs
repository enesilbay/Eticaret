...
namespace ETicaret.WebUI.Controllers
{
    public class CartController : Controller
    {
        ...
        public CartController(IService<Product> service, IService<Core.Entities.Address> serviceAddress, IService<AppUser> serviceAppUser, IService<Order> serviceOrder)
        {
            _service = service;
